...
#$ -pe smp 24
#$ -l mem_free=32G
#$ -o $HOME/Expression-model/logs/step2_ig_job5_$JOB_ID.out
#$ -e $HOME/Expression-model/logs/step2_ig_job5_$JOB_ID.err
#$ -m bea
#$ -M thingnguyen@uiowa.edu

# Job 5: k=160, 170, 180
K_VALUES="160 170 180"
N_TRIALS=50
...
echo "========================================"
echo "Step 2 (IG) - Job 5: k=160, 170, 180"
echo "========================================"
...
EXIT_STATUS=$?
echo ""
echo "Job 5 finished with status: $EXIT_STATUS | End: $(date)"
exit $EXIT_STATUS
