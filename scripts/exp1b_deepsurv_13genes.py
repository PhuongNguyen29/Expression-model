#!/usr/bin/env python3
"""
Experiment 1B: ElasticDeepSurv on 13 Overlapping Genes

Objective: Establish baseline performance on features shared between
           Cox 20 genes and DeepSurv 87 consensus genes.
...
EXPERIMENT_NAME = "exp1b_deepsurv_13genes"
GENE_FILE = "data/raw/overlap_genes_13.txt"
...
# Fixed hyperparameters (Option C - scaled for 13 genes)
FIXED_CONFIG = {
    'hidden_sizes': [32],  # Small architecture for very small input
    'dropout': 0.3,
    'learning_rate': 1e-4,
    'batch_size': 32,
    'alpha': 0.001,
...
def main():
    ...
    logger.info("="*70)
    logger.info(f"EXPERIMENT 1B: ElasticDeepSurv on 13 Overlapping Genes")
    logger.info("="*70)
