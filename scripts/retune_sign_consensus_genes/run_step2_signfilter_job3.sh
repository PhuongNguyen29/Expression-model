#!/bin/bash
#$ -N step2_signfilter_job3
#$ -cwd
#$ -V
#$ -q UI
#$ -pe smp 24
#$ -l mem_free=32G
#$ -o $HOME/Expression-model/logs/step2_signfilter_job3_$JOB_ID.out
#$ -e $HOME/Expression-model/logs/step2_signfilter_job3_$JOB_ID.err
#$ -m bea
#$ -M thingnguyen@uiowa.edu

# =============================================================================
# Job 3: k=80, 90 (Sign-Consistent Gene Pool)
# =============================================================================
...
echo "========================================"
echo "Step 2 (IG + Sign Filter) - Job 3"
echo "========================================"
...
echo ""
echo "========================================"
echo "Job 3 finished with status: $EXIT_STATUS"
echo "End: $(date)"
echo "========================================"
exit $EXIT_STATUS
