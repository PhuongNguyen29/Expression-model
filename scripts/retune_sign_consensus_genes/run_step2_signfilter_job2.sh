#!/bin/bash
#$ -N step2_signfilter_job2
#$ -cwd
#$ -V
#$ -q UI
#$ -pe smp 24
#$ -l mem_free=32G
#$ -o $HOME/Expression-model/logs/step2_signfilter_job2_$JOB_ID.out
#$ -e $HOME/Expression-model/logs/step2_signfilter_job2_$JOB_ID.err
#$ -m bea
#$ -M thingnguyen@uiowa.edu

# =============================================================================
# Job 2: k=60, 70 (Sign-Consistent Gene Pool)
# =============================================================================
...
echo "========================================"
echo "Step 2 (IG + Sign Filter) - Job 2"
echo "========================================"
...
echo ""
echo "========================================"
echo "Job 2 finished with status: $EXIT_STATUS"
echo "End: $(date)"
echo "========================================"
exit $EXIT_STATUS
