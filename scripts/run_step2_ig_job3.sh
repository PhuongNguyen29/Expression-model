...
#$ -pe smp 24
#$ -l mem_free=32G
#$ -o $HOME/Expression-model/logs/step2_ig_job3_$JOB_ID.out
#$ -e $HOME/Expression-model/logs/step2_ig_job3_$JOB_ID.err
#$ -m bea
...
echo "========================================"
echo "Step 2 (IG) - Job 3: k=120, 130"
echo "========================================"
...
EXIT_STATUS=$?
echo ""
echo "Job 3 finished with status: $EXIT_STATUS | End: $(date)"
exit $EXIT_STATUS
