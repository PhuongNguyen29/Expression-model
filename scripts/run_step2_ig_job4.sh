...
#$ -pe smp 16
#$ -l mem_free=32G
#$ -o $HOME/Expression-model/logs/step2_ig_job4_$JOB_ID.out
#$ -e $HOME/Expression-model/logs/step2_ig_job4_$JOB_ID.err
#$ -m bea
...
echo "========================================"
echo "Step 2 (IG) - Job 4: k=140, 150"
echo "========================================"
...
EXIT_STATUS=$?
echo ""
echo "Job 4 finished with status: $EXIT_STATUS | End: $(date)"
exit $EXIT_STATUS
