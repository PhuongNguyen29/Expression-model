"""
Hyperparameter tuning for DeepSurv and ElasticDeepSurv using Optuna
Based on: Akiba et al., 2019, "Optuna: A Next-generation Hyperparameter Optimization Framework"

MODIFICATIONS FOR ELASTICDEEPSURV:
- Added support for elastic net regularization hyperparameters
- Focused search space based on observed training issues
- Prioritizes learning_rate and alpha (most critical)
"""
...
class SurvivalModelHyperparameterTuner:
    """
    Hyperparameter tuning for survival models (DeepSurv, ElasticDeepSurv) using Optuna.
    ...
    - Simon et al., 2011: Elastic net for Cox models
    """
    ...
    def __init__(
        ...
        model_type: str = 'deepsurv',  # NEW: 'deepsurv' or 'elastic_deepsurv'
        ...
        Args:
            ...
            model_type: Type of model ('deepsurv' or 'elastic_deepsurv')
        ...
        if self.model_type not in ['deepsurv', 'elastic_deepsurv']:
    ...
    def create_model(self, trial: optuna.Trial):
        ...
        Supports both DeepSurv and ElasticDeepSurv.
        """
        # Sample-size-aware architecture constraints
        if self.n_samples < 500:  # TCGA - keep it simple
            ...
            if n_layers == 1:
                ...
                first = trial.suggest_categorical('first_layer_size', [256, 384])
        ...
        else:  # ORIEN - can handle more complexity
